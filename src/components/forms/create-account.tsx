      ...
      <Card>
        ...
        <CardContent>
          <div className={`grid gap-6`}>
            ...
            3.495.998.108-.776.417-1.305.76-1.605
            ...
            <form
              ...
              className="grid gap-4 font-inter"
            >
              <div className="grid gap-2 ">
                ...
                <DropdownMenu>
                  ...
                  >
                    {role.map((r) => (
                      <DropdownMenuItem
                        className="font-inter text-neutral-300"
                        key={r}
                        onSelect={() => {
                          setSelectedRole(() => r as "User" | "Company");
                          reset();
                          setValue(
                            "role",
                            r.toLowerCase() as "user" | "company"
                          );
                        }}
                      >
                        {r}{" "}
                        {r === selectedRole && <Check className="ml-auto" />}
                      </DropdownMenuItem>
                    ))}
                  </DropdownMenuContent>
                </DropdownMenu>
