            ...
            >
                ...
                >
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="space-y-2 grid-cols-2 grid ">
                            {features.map((feature, index) => (
                                <div
                                    key={feature.title}
                                    className="flex flex-col gap-2 text-sm text-zinc-700 dark:text-zinc-300 transition-all duration-500"
                                    style={{
                                        transform: isFlipped
                                            ? "translateX(0)"
                                            : "translateX(-10px)",
                                ...
                                >
                                    <p className="text-lg font-outfit font-semibold">{feature.title}</p>
