...
import AnimatedIcon from "@/app/_components/animated-icons";
      ...
      <DropdownMenu onOpenChange={setIsOpen}>
        <div className="group relative">
          ...
          <DropdownMenuContent
            sideOffset={4}
            align="end"
            className="w-62 ml-1 border-2 border-border p-2 bg-white/95 dark:bg-background backdrop-blur-sm   rounded-lg shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/20 
          ...
          >
            <div className="space-y-1">
              ...
              <DropdownMenuItem asChild>
                <div className="flex items-center p-3 hover:bg-zinc-100/80 dark:hover:bg-zinc-800/60 rounded transition-all duration-200 cursor-pointer group hover:shadow-sm border border-transparent hover:border-zinc-200/50 dark:hover:border-zinc-700/50">
                  <div className="flex items-center gap-2 flex-1">
                    <AnimatedIcon />
                    <span className="text-sm font-medium text-zinc-900 dark:text-zinc-100 tracking-tight leading-tight whitespace-nowrap group-hover:text-zinc-950 dark:group-hover:text-zinc-50 transition-colors">
                      Mode
            ...
            <DropdownMenuItem asChild>
              <button
                type="button"
                onClick={() => signOut()}
                className="w-full flex items-center gap-3 p-3 duration-200 bg-red-500/10 rounded hover:bg-red-500/20 cursor-pointer border border-transparent hover:border-red-500/30 hover:shadow-sm transition-all group"
              >
