...
import { Settings, CreditCard, FileText, LogOut, User, Moon } from "lucide-react";
        ...
        <div className={cn("relative", className)} {...props}>
            <DropdownMenu onOpenChange={setIsOpen}>
                <div className="group relative">
                    ...
                    <div
                        className={cn(
                            "absolute -right-1 top-1/2 -translate-y-1/2 transition-all duration-200",
                            isOpen
                                ? "opacity-100"
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={4}
                        className="w-64 p-2 bg-white/95 dark:bg-background backdrop-blur-sm border border-zinc-200/60 dark:border-zinc-800/60 rounded-xl shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/20 
